...
# CPU idles sooner. Static/menu scenes win (Genesis ~-18% CPU), motion is break-even; qualified
# on both devices, real-clock audio clean. Gate is presence-only (getenv!=NULL) — remove this
# prefix to disable; =0 would NOT disable.

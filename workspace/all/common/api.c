...
// Threading v2 depth-2 presents via GFX_flip (never-skip) — the vsync IS the pacer; serial games
// present via GFX_flipGame (presentation-drop catch-up). So the two pacing regimes never overlap.

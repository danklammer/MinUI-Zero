...
MinUI Zero is an independent personal fork of MinUI.

This project is made public for transparency, attribution, and convenience, but it is not a community-supported project. I am not soliciting source contributions, feature requests, support requests, commercial use, device ports, or long-term maintenance obligations.

This repository contains several categories of work:

1. Original MinUI code and assets, which remain copyright their original author(s).
2. MinUI Zero-specific changes, scripts, documentation, and configuration by Dan Klammer.
3. Third-party code, techniques, and files documented in `THIRD_PARTY_NOTICES.md`.
